...
class CreditCardValidatorTest(unittest.TestCase):
    ...
    def test_get_validity(self):
        self.card_validator.get_validity()
        expected_output = '**Credit Card Validity Status: Valid'
        self.assertEqual('**Credit Card Validity Status: Valid', expected_output)

    def test_get_card_type(self):
        self.card_validator.get_card_type()
        expected_output = '**Credit Card Type: Visa Card'
        self.assertEqual(expected_output, expected_output)

    def test_get_card_length(self):
        self.card_validator.get_card_length()
        expected_output = '**Credit Card Digit length: 16'
        self.assertEqual(expected_output, expected_output)

    def test_get_card_number(self):
        self.card_validator.get_card_number()
        expected_out = ''
